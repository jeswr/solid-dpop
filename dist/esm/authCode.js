 ...
 */
export function assertIssuerTransport(issuer) {
 ...
 */
export function assertEndpointTransport(endpoint, name) {
 ...
 */
export async function discoverProvider(issuer, fetchImpl = defaultFetch) {
 ...
 */
export async function registerClient(meta, redirectUri, opts = {}, fetchImpl = defaultFetch) {
    if (!meta.registration_endpoint) {
 ...
 */
export function staticClient(clientId, redirectUri, clientSecret) {
    return {
        client_id: clientId,
        redirect_uris: [redirectUri],
 ...
 */
export async function startLoopbackListener(path = "/callback") {
    let settled = false;
    let resolveOutcome;
 ...
 */
export async function refreshSession(session, fetchImpl = defaultFetch) {
 ...
 */
export async function cliLogin(opts) {
